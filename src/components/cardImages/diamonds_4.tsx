...
const SvgComponent = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width={'100%'} height={'100%'} >
    <title>{"Four of Diamonds Playing Card"}</title>
    <g transform="translate(0 -719.362)">
      ...
      />
      <path
        d="m58.63 814.076 28.243-28.336-28.243-28.337-28.244 28.337ZM58.63 1014.321l28.243-28.336-28.243-28.337-28.244 28.337ZM175.37 814.076l28.244-28.336-28.244-28.337-28.243 28.337ZM175.37 1014.321l28.244-28.336-28.244-28.337-28.243 28.337zM17.206 780.702l9.414-9.445-9.414-9.446-9.415 9.446zM216.794 991.022l9.415 9.446-9.415 9.445-9.414-9.445z"
        style={{
          fill: "red",
          fillOpacity: 1,
          stroke: "none",
